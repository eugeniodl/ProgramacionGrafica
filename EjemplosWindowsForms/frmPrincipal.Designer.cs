namespace EjemplosWindowsForms
{
    partial class frmPrincipal
    {
        ...
        private void InitializeComponent()
        {
            ...
            delagadosToolStripMenuItem = new ToolStripMenuItem();
            cálculoInterésCompuestoToolStripMenuItem = new ToolStripMenuItem();
            menuStrip1.SuspendLayout();
            SuspendLayout();
            // 
            // menuStrip1
            // 
            menuStrip1.Items.AddRange(new ToolStripItem[] { contenedoresToolStripMenuItem, delagadosToolStripMenuItem });
            ...
            // 
            delagadosToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { cálculoInterésCompuestoToolStripMenuItem });
            delagadosToolStripMenuItem.Name = "delagadosToolStripMenuItem";
            delagadosToolStripMenuItem.Size = new Size(74, 20);
            delagadosToolStripMenuItem.Text = "Delegados";
            // 
            // cálculoInterésCompuestoToolStripMenuItem
            // 
            cálculoInterésCompuestoToolStripMenuItem.Name = "cálculoInterésCompuestoToolStripMenuItem";
            cálculoInterésCompuestoToolStripMenuItem.Size = new Size(217, 22);
            cálculoInterésCompuestoToolStripMenuItem.Text = "Cálculo Interés Compuesto";
            cálculoInterésCompuestoToolStripMenuItem.Click += cálculoInterésCompuestoToolStripMenuItem_Click;
            // 
            // frmPrincipal
            // 
